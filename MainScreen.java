...
public class MainScreen {
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/img5.jpg"));
    ...
    public void addText()
    {
        ...
        text.setBounds(120,330,400,50);
        text.setForeground(Color.black);
        frame.add(text);
    }
    
    public void addProgressBar(){
        progressBar.setBounds(50,380,500,30); 
